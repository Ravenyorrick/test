...
To customize the displayed company name, document name, logo path, local PDF file name/path, or loading delay, edit the `page-config` JSON block near the bottom of `index.html`.
