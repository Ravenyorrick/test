...
To customize the displayed document and app file names, edit the `page-config` JSON block near the bottom of `index.html`.

The page does not automatically download files. Downloads require a user click and point to Adobe's official website.
