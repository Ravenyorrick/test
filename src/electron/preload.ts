...
const api = {
  ...
  startExtraction: (url: string, apiKey?: string, options?: { perPage?: number; autoEnrich?: boolean; revealPersonalEmails?: boolean; enrichmentConcurrency?: number; maxEmailRevealsPerRun?: number }): Promise<ExtractionSession> => ipcRenderer.invoke("extract:start", url, apiKey, options),
